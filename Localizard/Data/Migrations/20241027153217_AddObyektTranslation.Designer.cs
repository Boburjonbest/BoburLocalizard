...
namespace Localizard.Data.Migrations
{
    ...
    [Migration("20241027153217_AddObyektTranslation")]
    partial class AddObyektTranslation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Localizard.Models.ObyektPerevod", b =>
                {
                    ...
                    b.Property<string>("FileNameAndroid")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("FileNameIOS")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Localizard.Models.ObyektTranslation", b =>
                {
                    b.HasOne("Localizard.Models.ObyektPerevod", "ObyektPerevod")
                        .WithMany("Translations")
                        .HasForeignKey("ObyektPerevodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ObyektPerevod");
                });
